...
| `central_plant_cooler_size` | float\|null | kW (convert: 1 ton = 3.517 kW) |
...
| `central_plant_heater_size` | float\|null | kW (convert: MBH × 0.293 = kW) |
...
- 3 × 120 MBH boilers → 360 MBH × 0.293 = 105 kW total
- 500 MBH boiler → 500 × 0.293 = 146.5 kW
...
| `domestic_hot_water_heater_size` | float\|null | litres (convert: gallons × 3.785) |
...
| `rooftop_unit_size` | float\|null | kW total cooling capacity |
...
| `suite_heat_pump_size` | float\|null | kW per unit |
...
| `generic_hvac_equipment_size` | float\|null | kW |
